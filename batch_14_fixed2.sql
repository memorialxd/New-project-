...
DO $$ BEGIN DROP POLICY IF EXISTS "Public read app-branding" ON storage.objects; EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN
CREATE POLICY "Public read app-branding" ON storage.objects FOR SELECT USING (bucket_id = 'app-branding');
DO $$ BEGIN DROP POLICY IF EXISTS "Admins upload app-branding" ON storage.objects; EXCEPTION WHEN others THEN NULL; END $$;
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN
...
DO $$ BEGIN DROP POLICY IF EXISTS "Admins update app-branding" ON storage.objects; EXCEPTION WHEN others THEN NULL; END $$;
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN
...
DO $$ BEGIN DROP POLICY IF EXISTS "Admins delete app-branding" ON storage.objects; EXCEPTION WHEN others THEN NULL; END $$;
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN
