...
DROP POLICY IF EXISTS "Public read app-branding" ON objects;
DO $$ BEGIN
CREATE POLICY "Public read app-branding" ON storage.objects FOR SELECT USING (bucket_id = 'app-branding');
DROP POLICY IF EXISTS "Admins upload app-branding" ON objects;
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN
...
DROP POLICY IF EXISTS "Admins update app-branding" ON objects;
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN
...
DROP POLICY IF EXISTS "Admins delete app-branding" ON objects;
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN
